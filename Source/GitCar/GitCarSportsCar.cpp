...
#include "GitCarSportsCar.h"
#include "GitCarSportsWheelFront.h"
#include "GitCarSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AGitCarSportsCar::AGitCarSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGitCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGitCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGitCarSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGitCarSportsWheelRear::StaticClass();
