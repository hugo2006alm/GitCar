...
#include "GitCarOffroadCar.h"
#include "GitCarOffroadWheelFront.h"
#include "GitCarOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AGitCarOffroadCar::AGitCarOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGitCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGitCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGitCarOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGitCarOffroadWheelRear::StaticClass();
